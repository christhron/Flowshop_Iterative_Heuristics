...
#             Ks=pickle.load(file)
#             total_runtimes=pickle.load(file)
#             objHeur10s=pickle.load(file)
#             objHeur15s=pickle.load(file)
#             objHeur20s=pickle.load(file)
#             objHeur30s=pickle.load(file)
#             objHeur35s=pickle.load(file)
#             objHeurMin=pickle.load(file)
            
#     else:
#         with open('Output/timeVsNKEEP_50N_Selection.pkl','rb') as file:
#             numIns=pickle.load(file)
#             Ks=pickle.load(file)
#             total_runtimes=pickle.load(file)
#             objHeur10s=pickle.load(file)
